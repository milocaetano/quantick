...
use crate::journal::{EventJournal, EventPage};

pub const READ_CAPABILITY_ID: &str = "events.read";
pub const WAIT_CAPABILITY_ID: &str = "events.wait";
pub const EVENTS_MODULE_ID: &str = "events";
pub const EVENTS_PERMISSION_ID: &str = "observe.events";
...
pub fn complete_wait_page(mut page: EventPage, dropped_before: Option<EventCursor>) -> EventPage {
