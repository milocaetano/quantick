...
impl BookEngine {
    ...
    fn log_config_changed(&mut self, capture_grouping_changed: bool, action: &'static str) {
        ...
        tracing::info!(
            ...
            show_liquidity = self.config.show_liquidity,
            show_buy_aggressions = self.config.show_buy_aggressions,
            show_sell_aggressions = self.config.show_sell_aggressions,
            show_aligned_depletion = self.config.show_aligned_depletion,
            show_unattributed_reductions = self.config.show_unattributed_reductions,
            show_gaps = self.config.show_gaps,
