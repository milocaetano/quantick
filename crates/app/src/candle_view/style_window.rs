//! The appearance window: every candle and canvas setting the trader can
//! change, and the live preview under them.
...
pub fn draw_presets(ui: &mut egui::Ui, style: &mut ChartStyle, response: &mut StylePanelResponse) {
    ui.heading("Preset");
...
pub fn draw_body_settings(ui: &mut egui::Ui, style: &mut CandleStyle, changed: &mut bool) {
    ui.heading("Body");
...
pub fn draw_outline_settings(ui: &mut egui::Ui, style: &mut CandleStyle, changed: &mut bool) {
    ui.heading("Outline");
    *changed |= ui
        .add(
...
pub fn draw_wick_settings(ui: &mut egui::Ui, style: &mut CandleStyle, changed: &mut bool) {
    ui.heading("Wicks");
    *changed |= ui
...
pub fn draw_live_settings(ui: &mut egui::Ui, style: &mut CandleStyle, changed: &mut bool) {
...
pub fn draw_canvas_settings(ui: &mut egui::Ui, style: &mut ChartStyle, changed: &mut bool) {
    ui.heading("Canvas");
    *changed |= ui
        .checkbox(
...
pub fn draw_preview(ui: &mut egui::Ui, style: &ChartStyle) {
    ui.add_space(4.0);
