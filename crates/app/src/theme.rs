...
pub use palette::{
    ...
    DRAW_CYAN, DRAWING_SWATCHES, FLOAT_SHADOW, GAP_LABEL, GAP_LINE, INSET, POC, REC, SEAM_LABEL,
    SEAM_LINE, SELL, TAG_BG, TEXT_FAINT, TEXT_MUTED, TEXT_PRIMARY, TEXT_SUPPORT, WARN,
};
