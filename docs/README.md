...
| [`quality/mission-cost/method.md`](quality/mission-cost/method.md) | How a mission's tokens and wall clock are measured - registered before the first reading, with its thresholds and its error modes |
