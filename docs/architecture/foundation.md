...
| Appearance | [theme](../../crates/app/src/theme.rs), line 24 onward, fixes chrome tokens; [ChartStyle](../../crates/chart/src/style.rs), line 474, covers candles/canvas; [indicator style](../../crates/chart/src/indicator_style.rs), lines 29 and 109, preserves sparse user overrides over authored color. | Define resolved appearance and provenance before an installable theme format. |
